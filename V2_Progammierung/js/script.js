...
let textContentArray = [
    ...
    "Yes it is. You've travelled all the way back to the stone age. Back in this time humans needed to fight for their survival.",
    "I'm kind of scared now",
    "That's okay. Humans back then were smart enough to acquire the benefits of fire to protect themselves from animals. Try it out!",
    "Wow! That was easier than I thought",
    "I knew that you would make it. Your time here is over. Let's go on..."
...
let textContentArrayZukunft = [
    ...
    "Yes, they are. Now, we´re in the year 50.000. Look around, you´ll find a lot of interesting technologies which helped the world population defeat hunger, poverty and diseases. You can even live as long as you want to. ",
    "But … how ist that possible?",
    "humans found ways to gain a nearly infinite amount of ressources by travelling to other planets and stars",
    "And i thought they wouldn't even overcome the climate change",
    "They learned their lessons out of this mass extinction. Let's focus on something else. Look at this helmet over there. Try it on!",
    "What is it supposed to do?",
    "Just stare at some objects in this room and see the magic... You can start with that pizza if you cant decide",
    "WOw that's so cool!",
    "Now you've seen what the future is offering. Let´s get back to where we started our journey...."
];
